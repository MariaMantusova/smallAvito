        ...
        <section className="form-section">
            ...
            <form className="form">
                ...
                <p className={`form__error ${((title.isEmpty && title.isDirty) ||
                    !(title.isEmpty && title.isDirty && title.stringError) ||
                    !(title.isEmpty && title.isDirty && title.minLengthError) ||
                    !(title.isEmpty && title.isDirty && title.maxLengthError)) && "form__error_visible"}`}>
                ...
                <p className={`form__error ${((description.isEmpty && description.isDirty) ||
                    !(description.isEmpty && description.isDirty && description.stringError) ||
                    !(description.isEmpty && description.isDirty && description.minLengthError) ||
                    !(description.isEmpty && description.isDirty && description.maxLengthError)) && "form__error_visible"}`}>
                ...
                <p className={`form__error ${((location.isEmpty && location.isDirty) ||
                    !(location.isEmpty && location.isDirty && location.stringError) ||
                    !(location.isEmpty && location.isDirty && location.minLengthError) ||
                    !(location.isEmpty && location.isDirty && location.maxLengthError)) && "form__error_visible"}`}>
                ...
                <p className={`form__error ${(
                    !(photo.isEmpty && photo.isDirty && photo.urlError) ||
                    !(photo.isEmpty && photo.isDirty && photo.minLengthError) ||
                    !(photo.isEmpty && photo.isDirty && photo.maxLengthError)) && "form__error_visible"}`}>
